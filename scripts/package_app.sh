#!/usr/bin/env bash
#
# package_app.sh — 把一日一笺打包成未公证的应用和磁盘镜像
#
...
# ---- 基本配置 ----------------------------------------------------------------
APP_NAME="一日一笺"                 # 用户可见的应用名
DISPLAY_NAME="一日一笺"             # 应用显示名
EXEC_NAME="Dayleaf"                 # 内部可执行文件名，与 Package.swift 一致
...
# ---- 4. 写 Info.plist --------------------------------------------------------
echo "==> 写 Info.plist"
SHORT_VERSION="${DAYLEAF_VERSION:-1.0}"
